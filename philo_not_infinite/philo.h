...
/*   Updated: 2022/05/11 19:27:07 by kwarpath         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	simulate(t_fork *forks, t_philo *philos, t_data_ph *util, int j);
...
void	ft_update_last_time_eat(t_timeval *tv, t_philo *philo,
			int was_sleeping);
