...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2022/04/30 16:14:21 by kwarpath          #+#    #+#             */
/*   Updated: 2022/04/30 16:25:07 by kwarpath         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */

#include "philo.h"

int	ft_philos_init(t_philo *philo, int num_philo,
	t_fork *forks, t_data *util)
{
	int			i;
	pthread_t	ptid;
...
int	ft_philo_was_died(t_philo *philo, t_data *util)
{
